...
- Мобильная версия и мобильное меню с плавным появлением и исчезновением,
- Для входа в приложение нужно зарегистрироваться или авторизоваться.
